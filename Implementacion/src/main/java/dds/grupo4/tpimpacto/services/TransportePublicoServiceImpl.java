...
@Service
public class TransportePublicoServiceImpl extends BaseServiceImpl<TransportePublico, TransportePublicoRepository> implements TransportePublicoService {

    private final DireccionService direccionService;
    private final CombustibleRepository combustibleRepository;
    private final ParadaRepository paradaRepository;

    public TransportePublicoServiceImpl(TransportePublicoRepository repository, DireccionService direccionService, CombustibleRepository combustibleRepository, ParadaRepository paradaRepository) {
        super(repository);
